...
public class YapiDenetimDTO {
    ...
    private String vekilAdSoyad;
    private String raportor;
    private String mahalleAdı;
    private String yibf;
    ...
    public String getVekilAdSoyad() {
        return vekilAdSoyad;
    }

    public void setVekilAdSoyad(String vekilAdSoyad) {
        this.vekilAdSoyad = vekilAdSoyad;
    }
    ...
    public String getMahalleAdı() {
        return mahalleAdı;
    }

    public void setMahalleAdı(String mahalleAdı) {
        this.mahalleAdı = mahalleAdı;
    }

    public String getYibf() {
        return yibf;
    }

    public void setYibf(String yibf) {
        this.yibf = yibf;
    }
