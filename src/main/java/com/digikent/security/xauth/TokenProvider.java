package com.digikent.security.xauth;
...
public class TokenProvider {
	...
	private JWSInput jwsInput(String authToken) throws JWSInputException {
		if (null == authToken) {
			return null;
		}
		return new JWSInput(authToken);
	}

	public KeycloakUserToken convertJWT2Object(String jwtToken) throws JWSInputException {
		return jwsInput(jwtToken).readJsonContent(KeycloakUserToken.class);
	}
