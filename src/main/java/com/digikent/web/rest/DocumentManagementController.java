...
public class DocumentManagementController {
	...
	//EBYS bekleyen belge
	@RequestMapping(value="EBYSBekleyen",method = RequestMethod.POST)
	public List<EBYS> getWaitingEBYS(@RequestBody EBYSRequestDTO ebysRequestDTO){

		LOG.debug("Rest Request to get ebys onay bekleyen persid, rolid, startDate, endDate: {}",
				ebysRequestDTO.getFsm1UserId(), ebysRequestDTO.getRolId(), ebysRequestDTO.getStartDate(), ebysRequestDTO.getEndDate());
		return documentManagementService.getEBYS("ONAYBEKLEYEN", ebysRequestDTO);
	}

	//EBYS tamamlanan belge
	@RequestMapping(value="EBYSTamamlanan",method = RequestMethod.POST)
	public List<EBYS> getCompletedEBYS(@RequestBody EBYSRequestDTO ebysRequestDTO){

		LOG.debug("Rest Request to get ebys tamamlanan persid, rolid, startDate, endDate: {}",
				ebysRequestDTO.getFsm1UserId(),ebysRequestDTO.getRolId() ,ebysRequestDTO.getStartDate(),ebysRequestDTO.getEndDate());
		return documentManagementService.getEBYS("TAMAMLANAN", ebysRequestDTO);
	}
